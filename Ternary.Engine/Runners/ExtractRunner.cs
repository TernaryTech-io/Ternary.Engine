...
public class ExtractRunner : WorkRunner<ExtractService>
{
    public override async Task<WorkItem> RunItemAsync(WorkItem item, IWorkContext context)
    {
        ...
        try
        {
            ...
            var entity = await GetEntity<ExtractEntity>(item);
            ...
            var refItem = await Service.FindAsync<ExtractEntity>(12345);
            ...
            var service = scope.ServiceProvider.GetService<ExtractDbContext>();
