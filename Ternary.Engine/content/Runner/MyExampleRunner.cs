...
public class MyExampleRunner : WorkRunner<MyExampleService>
{
    public override async Task<WorkItem> RunItemAsync(WorkItem item, IWorkContext context)
    {
        ...
        try
        {
            ...
            var entity = await GetEntity<MyExampleEntity>(item);
            ...
            var refItem = await Service.FindAsync<MyExampleEntity>(12345);
            ...
            var service = scope.ServiceProvider.GetService<MyExampleDbContext>();
